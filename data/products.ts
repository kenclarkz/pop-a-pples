...
export const products: Product[] = [
  ...
  },
  {
    id: 'turtle',
    name: 'Turtle',
    tagline: 'Chocolate, caramel and pecans — the classic trio.',
    description:
      'A crisp apple dunked in rich caramel, drizzled with chocolate and rolled in roasted pecans for that turtle-candy crunch.',
    price: 20,
    category: 'gourmet-apples',
    sizes: ['Standard'],
    image: asset('/assets/products/turtle.svg'),
    ingredients: ['Honeycrisp Apple', 'Caramel', 'Chocolate Drizzle', 'Roasted Pecans'],
    isNew: true,
    rating: 4.9,
    allergens: ['Milk', 'Soy', 'Tree Nuts (Pecans)'],
  },
  {
    id: 'peanut-butter-galore',
    name: 'Peanut Butter Galore',
    tagline: 'A peanut butter lover’s dream, on a stick.',
    description:
      'Caramel-dipped and slathered in creamy peanut butter, then buried in a generous coat of crushed roasted peanuts.',
    price: 19,
    category: 'gourmet-apples',
    sizes: ['Standard'],
    image: asset('/assets/products/peanut-butter-galore.svg'),
    ingredients: ['Granny Smith Apple', 'Caramel', 'Creamy Peanut Butter', 'Crushed Peanuts'],
    isNew: true,
    rating: 4.8,
